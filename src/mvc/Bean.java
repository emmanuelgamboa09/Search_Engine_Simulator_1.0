...
abstract public class Bean implements Serializable {
	...
	//Used to first a vetoable change
	public void fireVetoableChange(String propertyName, Object oldValue, Object newValue) throws PropertyVetoException {
		mVcs.fireVetoableChange(propertyName, oldValue, newValue);
	}

	//Used to fire a property change
	public void firePropertyChange(String propertyName, Object oldValue, Object newValue) {
		mPcs.firePropertyChange(propertyName, oldValue, newValue);
	}

	//Adds property change listener to our mPcs
	public void addPropertyChangeListener(PropertyChangeListener listener) {
		mPcs.addPropertyChangeListener(listener);
	}
	
	//Removes property change listener from our mPcs
	public void removePropertyChangeListener(PropertyChangeListener listener) {
		mPcs.removePropertyChangeListener(listener);
	}
	
	//Adds vetoable change listener to our mVcs
	public void addVetoableChangeListener(VetoableChangeListener listener) {
		mVcs.addVetoableChangeListener(listener);
	}

	//Removes vetoable change listener from our mVcs
